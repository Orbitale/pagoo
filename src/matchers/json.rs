...
pub(crate) fn match_json(body_as_string: &String, matcher: &Matcher) -> bool {
...
mod tests {
    ...
    fn test_match_json() {
        ...
        assert_eq!(match_json(&body_as_string, &matcher), true);
    }
    ...
    fn test_not_match_json() {
        ...
        assert_eq!(match_json(&body_as_string, &matcher), false);
    }
}